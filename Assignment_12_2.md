...
int main() {
    ...
    cout << "Using Linear Probing with Chaining With Replacement Method" << endl;
...
Using Linear Probing with Chaining With Replacement Method
...
9	131	Dr. Sunita Reddy		Civil		Professor		72000	Occupied
========================
...
Index	Emp ID	Name		Department	Designation	Salary	Status
------------------------------------------------------------------------
0	151	Dr. Meera Singh		Mathematics		Assistant Professor		52000	Occupied
1	141	Dr. Deepak Kumar		Electrical		Associate Professor		62000	Occupied
2	EMPTY	EMPTY		EMPTY		EMPTY		EMPTY	Empty
3	EMPTY	EMPTY		EMPTY		EMPTY		EMPTY	Empty
4	EMPTY	EMPTY		EMPTY		EMPTY		EMPTY	Empty
