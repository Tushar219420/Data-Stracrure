...
struct StudentNode_TVV {
    ...
    StudentNode_TVV(int rollNo, const char* name, float marks) {
        rollNo_TVV = rollNo;
...
public:
    ...
    void insert_TVV(int rollNo, const char* name, float marks) {
        ...
        StudentNode_TVV* newNode = new StudentNode_TVV(rollNo, name, marks);
...
int main() {
    ...
    cout << "=== Hash Table Implementation with Separate Chaining ===" << endl;
...
=== Hash Table Contents ===
Bucket 0: Empty
Bucket 1: [141, Deepak, 91.5] 
Bucket 2: Empty
Bucket 3: Empty
Bucket 4: Empty
Bucket 5: Empty
Bucket 6: Empty
Bucket 7: [101, Arjun, 85.5] 
Bucket 8: [111, Priya, 92] 
Bucket 9: [131, Sunita, 88] [121, Rohan, 78.5] 
==========================
...
=== Hash Table Contents ===
Bucket 0: Empty
Bucket 1: [141, Deepak, 91.5] [151, Meera, 87.5] 
Bucket 2: Empty
Bucket 3: Empty
Bucket 4: Empty
Bucket 5: Empty
